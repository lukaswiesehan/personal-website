...
export const Input = forwardRef(({id, type, placeholder, error, onBlur}, ref) => {
  return (
    <input className={`px-3 h-8 w-full rounded-lg border-none border-warm-gray-100 dark:border-cool-gray-500 bg-warm-gray-100 dark:bg-cool-gray-600
      placeholder-gray-500 dark:placeholder-cool-gray-400 text-gray-700 dark:text-cool-gray-100
